...
class AuthenController extends ControllerBase{
  ...
  public function indexAction(){
    ...
    if($this->request->isPost()){
      ...
      $this->session->set('memberAuthen', $member->id); // กำหนด session  //$_SESSION['memberAuthen']
            ...
            $this->flashSession->error('Password Incorrect'); // เก็บ error ที่แสดงไว้ใน flash //แสดงerrorตรงหน้าที่ผิดพลาดอย่างสวยงาม
          }
        }else{
  ...
  public function signOutAction(){
	  $this->removeSession() ;//session_unset(); logout already
